...
const DAILY_VERSES = [
  ...
  { text: "Be ye stedfast, unmoveable, always abounding in the work of the Lord.", reference: "1 Corinthians 15:58 KJV" },
  { text: "For God is not unrighteous to forget your work and labour of love.", reference: "Hebrews 6:10 KJV" },
  { text: "Let us not be weary in well doing: for in due season we shall reap.", reference: "Galatians 6:9 KJV" },
  { text: "Except the Lord build the house, they labour in vain that build it.", reference: "Psalm 127:1 KJV" },
  ...
  { text: "Let no corrupt communication proceed out of your mouth, but that which is good to the use of edifying.", reference: "Ephesians 4:29 KJV" },
  { text: "A soft answer turneth away wrath: but grievous words stir up anger.", reference: "Proverbs 15:1 KJV" },
  { text: "Let your speech be alway with grace, seasoned with salt.", reference: "Colossians 4:6 KJV" },
  { text: "Be ye kind one to another, tenderhearted, forgiving one another.", reference: "Ephesians 4:32 KJV" },
  { text: "Let nothing be done through strife or vainglory; but in lowliness of mind.", reference: "Philippians 2:3 KJV" },
  { text: "Do justly, and to love mercy, and to walk humbly with thy God.", reference: "Micah 6:8 KJV" },
  { text: "Blessed are the peacemakers: for they shall be called the children of God.", reference: "Matthew 5:9 KJV" },
  { text: "Rejoice evermore. Pray without ceasing. In every thing give thanks.", reference: "1 Thessalonians 5:16-18 KJV" },
  { text: "Be swift to hear, slow to speak, slow to wrath.", reference: "James 1:19 KJV" },
  { text: "Let your light so shine before men, that they may see your good works.", reference: "Matthew 5:16 KJV" },
  { text: "Seek ye first the kingdom of God, and his righteousness.", reference: "Matthew 6:33 KJV" },
  { text: "The steps of a good man are ordered by the Lord.", reference: "Psalm 37:23 KJV" },
  { text: "Whatsoever thy hand findeth to do, do it with thy might.", reference: "Ecclesiastes 9:10 KJV" },
  ...
  { text: "My grace is sufficient for thee: for my strength is made perfect in weakness.", reference: "2 Corinthians 12:9 KJV" },
  ...
  { text: "The peace of God, which passeth all understanding, shall keep your hearts and minds.", reference: "Philippians 4:7 KJV" },
  { text: "Now unto the King eternal, immortal, invisible, the only wise God, be honour and glory.", reference: "1 Timothy 1:17 KJV" },
];
const getDailyVerse = () => {
  const now = new Date();
